...
<head>
  ...
  <%
    ...
    session.setAttribute("theRoleID", Roleid);                           
...
<td width="820" style="background-color: aliceblue">
    ...
    <tr><td>        
        <table border="0" width="820" style="background-color: lightgrey">  
            ...
            <tr >
                <Form Name="loginform" Method="POST"  Action="db/insertUserDb.jsp" >
                    <input type="hidden" name="Username" value="<%= request.getParameter( "username" )%>" />
                    <input type="hidden" name="Fullname" value="<%= request.getParameter( "fullname" )%>" />
                    <input type="hidden" name="Password1" value="<%= request.getParameter( "password1" )%>" />
                               ...
                               <table border="0" width="560" height="400" style="background-color: white">  
                                    ...
                                    <tr>
                                        <td  align="left" height="40" valign="top" style="font-family: Times New Roman; font-size: 20px"  >
                                            ...
                                            <input type="text" name="answer1" value="" size="15"  required style="line-height: 20px; font-size:18px"/>                               	
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" align="left" height="40" valign="center" style="font-family: Times New Roman; font-size: 20px" >
                                    ...
                                    <tr>
                                        <td  align="left" height="40" valign="top" style="font-family: Times New Roman; font-size: 20px"  >
                                            ...
                                            <input type="text" name="answer2" value="" size="15"  required style="line-height: 20px; font-size:18px"/>                               	
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" align="left" height="40" valign="center" style="font-family: Times New Roman; font-size: 20px" >
                                    ...
                                    <tr>
                                        <td  align="left" height="40" valign="top" style="font-family: Times New Roman; font-size: 20px"  >
                                            ...
                                            <input type="text" name="answer3" value="" size="15"  required style="line-height: 20px; font-size:18px"/>                               	
                                        </td>
                                    </tr>
                               </table>         
                            </td>
