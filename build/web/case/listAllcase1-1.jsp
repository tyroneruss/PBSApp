        ...
        <table border="0" width="1000" style="background-color: lightgrey">  
            ...
            <table border="0" width="1000" style="background-color: #a6a6a6">
                <tr>
                    ...
                    <td width="150" align="center" valign="center" style="font-family: Times New Roman; font-size: 18px">
                      <font  color="white" >
                        <a href="newcase1-0.jsp" style="color: white;" >
                            <b>Create New Case</b>
                        </a>
                       </font>                    
                    </td>
            ...
            <td colspan="8">      
                ...
                <%
                    ...
                    while((next=resultset.next()) && i < skip) {
                        ...
                        statement = connection.createStatement();
                        String User_id = resultset.getString(11);
                        String QueryUser = "Select FullName from User "
                                         + "Where UserId=" + User_id;                               
                        
                        ResultSet resultset1 = statement.executeQuery(QueryUser);
                        resultset1.next();
                ...
                %>
                    <tr>
                        ...
                        <td width="6%"  align="center"  valign="top" <%=stylevalue %>  >
                            <a href="../debtor_old/debtor1-1a.jsp?caseid=<%= resultset.getInt(1)%>" >
