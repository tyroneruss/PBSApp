    ...
    <table border="0" width="850" >         
        ...
        <tr >
            <td width="850"  style="background-color: white">    
                    ...
                    <table border="0" style="background-color: white">
                        <tr>
                          ...
                          <td width="70%" height="25" style="font-family: Times New Roman; font-size: 15px" >
                              <input type="text" name="address1" value="" size="50" Required />
                          </td> <!-- End first TD col -->  
                        </tr>                             
                        <tr>
                          <td width="10%" height="25" style="font-family: Times New Roman; font-size: 15px">
                          ...
                          <td width="70%" height="25" style="font-family: Times New Roman; font-size: 15px" >
                              <input type="text" name="address2" value=""  size="50" />
                          </td> <!-- End first TD col -->  
                        </tr>                             
                        <tr>
                          <td width="10%" height="25" style="font-family: Times New Roman; font-size: 15px">
                ...
                <tr>
                    <td colspan="2" height="50" align="right" valign="center" style="background-color: lightgrey;" >                     
