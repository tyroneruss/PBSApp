...
<table border="0" width='1010' style="background-color: lightgrey">
     <tr >
        ...
        <table border="0" width="1000" style="background-color: #a6a6a6">
            <tr>
                ...
                <td width="165" align="center" valign="center" >
                      <font  color="white" size="3" >
                        <a href="mycases.jsp?userid=<%= session.getAttribute("userid") %>"
                           style="color: white;" >
                            List My Cases </a>
                       </font>                    
                </td>
...
<div id='tab-1' class="tab">   
    <table border="0" width="1000" >         
        ...
        <tr>
            <td colspan="8" height="30" align="center" valign="center" style="background-color: lightgrey" >                     
            </td>
        </tr> 
    </table>     
</div> 
