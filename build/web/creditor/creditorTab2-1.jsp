...
<table border="0" cellpadding="15" cellspacing="0" align="center" >
    ...
    <table border="0" width='1045' style="background-color: lightgrey">
            <tr >
                ...
                <td align="center" >
                    <h2> Preparing - Chapter 7 Bankruptcy 
                        <br>Voluntary Petition
                    </h2>
                </td>
            </tr>
    </table>
    ...
    <div id="tabs" >
      <ul>
        <li><a href="#tabs-1">Debitor's Profile</a></li>
                              ...
                              <br>
                               <tr>
                                    <td  colspan="2" style="background-color: white" width="300" height="50"> 
                                        <!-- first TD col -->  
                                        &nbsp;&nbsp;&nbsp;<input type="button" onclick="window.location.href='debitorTab3.jsp'" 
                                        value="Done"  style="height:35px;width:110px" />
                                        &nbsp;&nbsp;&nbsp;<input type="button" onclick="window.location.href='javascript:history.back()'"
                                        value="Back "  style="height:35px;width:110px" />
