...
<td width="950" style="background-color: white">
    ...
    <table border="0" width="970" >         
        <tr>
            <td weight="55%" height="30" valign="center" align="center"
                 style="background-color: aliceblue; font-family: Times New Roman; font-size: large" >
                 x <font color="#2F4F4F" size="4">
                     <b>Add New Creditor </b>
                 </font>
             </td>
             <td weight="45%" align="right" weight="45%"  style="background-color: aliceblue;" >
                     <b>Case Number (if known):</b> 
                      <input type="text" name="companyname" size="30" value="<%= resultset.getString("CaseNumber") %>" />                                                   
             </td> <% } %>
        </tr> 
        <tr>
            ...
            <form name="DebtorForm1-1" METHOD=POST ACTION="creditorCase1-1.jsp">          
            <table border="0" style="background-color: white">
                        <tr>
                            ...
                            <td width="40%" height="28" style="font-family: Times New Roman; font-size: 17px" >
                              <input type="text" name="companyname" size="80" value="" />                              
                            </td>
                        </tr>                             
                        <tr>
                            <td width="5%" height="28" style="font-family: Times New Roman; font-size: 17px">
